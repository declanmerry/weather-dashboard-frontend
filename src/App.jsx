...
const particleOptions = {
  clear: {
    ...
    particles: {
      ...
      color: { value: "#fff" },
      size: { value: 2 },
      move: { speed: 0.5, direction: "top", outModes: "out" },
      opacity: { value: 0.7 },
    },
  },
  cloud: {
    ...
    particles: {
      ...
      shape: { type: "circle" },
      size: { value: 20 },
      move: { speed: 0.2, direction: "top", outModes: "out" },
      opacity: { value: 0.3 },
    },
  },
  rain: {
    ...
    particles: {
      ...
      shape: { type: "line" },
      size: { value: 2 },
      move: { speed: 25, direction: "bottom", straight: true, outModes: "out" },
      opacity: { value: 0.5 },
    },
  },
  snow: {
    ...
    particles: {
      ...
      shape: { type: "circle" },
      size: { value: 4 },
      move: { speed: 1, direction: "bottom", outModes: "out" },
      opacity: { value: 0.8 },
    },
  },
  thunder: {
    ...
    particles: {
      ...
      color: { value: "#f1c40f" },
      size: { value: 8 },
      move: { speed: 10, direction: "random", outModes: "out" },
      opacity: { value: 1 },
    },
  },
  mist: {
    ...
    particles: {
      ...
      shape: { type: "circle" },
      size: { value: 15 },
      move: { speed: 0.3, direction: "top", outModes: "out" },
      opacity: { value: 0.2 },
    },
  },
  default: {
